...
_FOOTER_RE = re.compile(
    ...
    r"REPRESENTANTE\s+LEGAL|PAGINA|PAGE|EMPRESA|GIRO|FIRMA|FIRMAS|"
    ...
    r"CIUDAD|REGION|COMUNA|"
    r"TOTALES\s+IGUALES|TOTAL\s+GENERAL|TOTALES\s+GENERALES|"
    r"SUMAS\s+IGUALES|SUMAS\s+GENERALES)\b",
    re.I,
)
