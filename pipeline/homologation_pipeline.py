...
class HomologationPipeline:
    ...
    _ACCOUNT_ABBREVIATIONS: list[tuple[re.Pattern, str]] = [
        ...
        (re.compile(r"\bcta\.?\s*cte\.?\s*socios(?:\.|\b)", re.I), "cuenta corriente socios "),
        (re.compile(r"\bcta\.?\s*cte\.?\s*", re.I), "cuenta corriente "),
        (re.compile(r"\bctas\.?\s*ctes\.?\s*", re.I), "cuentas corrientes "),
        (re.compile(r"\bc\s*/\s*c(?:\.|\b)\s*", re.I), "cuenta corriente "),
        (re.compile(r"\bc\s*\.\s*c\s*\.(?:\.|\b)\s*", re.I), "cuenta corriente "),
        (re.compile(r"\bcta(?:\.|\b)\s*", re.I), "cuenta "),
        (re.compile(r"\bctas(?:\.|\b)\s*", re.I), "cuentas "),
        (re.compile(r"\bc\s*x\s*c(?:\.|\b)\s*", re.I), "cuentas por cobrar "),
        (re.compile(r"\bc\s*x\s*p(?:\.|\b)\s*", re.I), "cuentas por pagar "),
        (re.compile(r"\bcxc(?:\.|\b)\s*", re.I), "cuentas por cobrar "),
        (re.compile(r"\bcxp(?:\.|\b)\s*", re.I), "cuentas por pagar "),
        (re.compile(r"\bcps(?:\.|\b)\s*", re.I), "cuenta particular socios "),
        (re.compile(r"\bdpp(?:\.|\b)\s*", re.I), "deudores por ventas "),
        (re.compile(r"\bcfe(?:\.|\b)\s*", re.I), "cuentas por cobrar "),
        (re.compile(r"\bp\.?p\.?m\.?(?:\.|\b)\s*", re.I), "pagos provisionales mensuales "),
        (re.compile(r"\bptmos(?:\.|\b)\s*", re.I), "prestamos "),
        (re.compile(r"\bptmo(?:\.|\b)\s*", re.I), "prestamo "),
        ...
        (re.compile(r"\brem(?:\.|\b)\s*", re.I), "remuneraciones "),
        (re.compile(r"\bmob(?:\.|\b)\s*", re.I), "mobiliario "),
        (re.compile(r"\bvehic(?:\.|\b)\s*", re.I), "vehiculos "),
        (re.compile(r"\bterr(?:\.|\b)\s*", re.I), "terrenos "),
        (re.compile(r"\bdeud(?:\.|\b)\s*", re.I), "deudores "),
        (re.compile(r"\bacreed(?:\.|\b)\s*|\bacr(?:\.|\b)\s*", re.I), "acreedores "),
    ]
